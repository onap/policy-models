...
public class ConsumerGroupData {
     ...
     * because it is being removed from the topic.
     */
    public static final List<String> UNREADABLE_LIST = Collections.unmodifiableList(Collections.emptyList());

    /**
     * Returned when there are no messages read.
     */
    private static final List<String> EMPTY_LIST = Collections.unmodifiableList(Collections.emptyList());
