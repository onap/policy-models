...
public class PolicyTypeImplProvider {
    ...
    public JpaPolicyTypeImpl deletePolicyTypeImpl(@NonNull final PfDao dao, @NonNull PfConceptKey key)
        ...
        try {
            ...
            JpaPolicyTypeImpl policyImplToBeDeleted = dao.get(JpaPolicyTypeImpl.class, key);

            if (policyImplToBeDeleted == null) {
                throw new Exception("policy type impl not found in the database");
            }
