...
public class ToscaModel extends PfModel {
    ...
    public ToscaModel(final PfConceptKey key) {
        this(key, new ToscaServiceTemplates(new PfConceptKey(key.getName() + "_ServiceTemplates", key.getVersion())));
    }
    ...
    public PfConcept copyTo(@NonNull final PfConcept targetObject) {
        ...
        Assertions.instanceOf(copyObject, ToscaModel.class);

        final ToscaModel copy = ((ToscaModel) copyObject);
