...
public class JpaToscaTopologyTemplate extends PfConcept implements PfAuthorative<ToscaTopologyTemplate> {
    ...
    @ElementCollection
    @Lob
    private Map<String, JpaToscaParameter> inputs = new LinkedHashMap<>();
    ...
    public JpaToscaTopologyTemplate(final JpaToscaTopologyTemplate copyConcept) {
        ...
        this.nodeTemplates = (copyConcept.nodeTemplates != null
            ? new JpaToscaNodeTemplates(copyConcept.nodeTemplates) : null);
