...
public class JpaToscaTopologyTemplate extends PfConcept implements PfAuthorative<ToscaTopologyTemplate> {
    ...
    public BeanValidationResult validate(@NonNull final String fieldName) {
        ...
        Validation.validateItems(result, "inputs", inputs, false);
        Validation.validateItem(result, "nodeTemplates", nodeTemplates, false);
        Validation.validateItem(result, "policies", policies, false);
