...
public class ToscaDataTypes extends PfConceptContainer<ToscaDataType> {
     ...
     */
    public ToscaDataTypes(@NonNull final PfConceptKey key) {
     ...
     */
    public ToscaDataTypes(@NonNull final PfConceptKey key, @NonNull final Map<PfConceptKey, ToscaDataType> conceptMap) {
     ...
     */
    public ToscaDataTypes(@NonNull final ToscaDataTypes copyConcept) {
        super(copyConcept);
    }
}
