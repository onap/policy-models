...
public class ToscaPolicies extends PfConceptContainer<ToscaPolicy> {
    ...
    /**
     * The Default Constructor creates a {@link ToscaPolicies} object with a null artifact key
    ...
    /**
     * The Key Constructor creates a {@link ToscaPolicies} object with the given artifact key
     * and creates an empty concept map.
     *
     * @param key the concept key
     */
    public ToscaPolicies(@NonNull final PfConceptKey key) {
     ...
     */
    public ToscaPolicies(@NonNull final PfConceptKey key, @NonNull final Map<PfConceptKey, ToscaPolicy> conceptMap) {
     ...
     */
    public ToscaPolicies(@NonNull final ToscaPolicies copyConcept) {
        super(copyConcept);
    }
}
