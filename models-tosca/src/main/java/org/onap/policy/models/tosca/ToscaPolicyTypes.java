...
public class ToscaPolicyTypes extends PfConceptContainer<ToscaPolicyType> {
     ...
     */
    public ToscaPolicyTypes(@NonNull final PfConceptKey key) {
     ...
     */
    public ToscaPolicyTypes(@NonNull final PfConceptKey key,
            @NonNull final Map<PfConceptKey, ToscaPolicyType> conceptMap) {
     ...
     */
    public ToscaPolicyTypes(@NonNull final ToscaPolicyTypes copyConcept) {
        super(copyConcept);
    }
}
