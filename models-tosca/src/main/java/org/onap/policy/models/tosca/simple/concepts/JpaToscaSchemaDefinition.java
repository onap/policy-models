...
public class JpaToscaSchemaDefinition
        implements PfAuthorative<ToscaSchemaDefinition>, Validated, Serializable, Comparable<JpaToscaSchemaDefinition> {
    ...
    public BeanValidationResult validate(@NonNull final String fieldName) {
        ...
        Validation.validateNotNull(result, "type", type, false);
