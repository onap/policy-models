...
@NoArgsConstructor
@ToString
public class PolicyTypeImpl implements Serializable {
     ...
     */
    public PolicyTypeImpl(@NonNull PolicyTypeImpl copyObject) {
        ...
        if (copyObject.metadata != null) {
            metadata = new LinkedHashMap<>(copyObject.metadata);
        }
    }
