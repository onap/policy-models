...
public final class ToscaConstraintLogicalKey extends ToscaConstraintLogical {
     ...
     */
    public ToscaConstraintLogicalKey(@NonNull final PfReferenceKey key) {
     ...
     *        be compared
     */
    public ToscaConstraintLogicalKey(@NonNull final PfReferenceKey key, @NonNull final Operation operation,
    ...
    public PfValidationResult validate(final PfValidationResult resultIn) {
        ...
        if (compareToKey == null || compareToKey.isNullKey()) {
