...
public class ToscaProperty extends PfConcept {
    ...
    public PfValidationResult validate(final PfValidationResult resultIn) {
        ...
        if (status == null) {
            result.addValidationMessage(new PfValidationMessage(key, this.getClass(), ValidationResult.INVALID,
                    "property status may not be null"));
        }
        ...
        return entrySchema.validate(result);
    }
    ...
    public PfConcept copyTo(@NonNull final PfConcept target) {
        ...
        final ToscaProperty copy = ((ToscaProperty) copyObject);
        ...
        copy.setEntrySchema(new ToscaEntrySchema(entrySchema));
