...
public class JpaToscaEntrySchema
        implements PfAuthorative<ToscaSchemaDefinition>, Validated, Serializable, Comparable<JpaToscaEntrySchema> {
    ...
    public BeanValidationResult validate(@NonNull final String fieldName) {
        ...
        Validation.validateNotNull(result, "type", type, true, true);
