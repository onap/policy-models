...
public class ToscaServiceTemplates extends PfConceptContainer<ToscaServiceTemplate> {
     ...
     */
    public ToscaServiceTemplates(@NonNull final PfConceptKey key) {
     ...
     */
    public ToscaServiceTemplates(@NonNull final PfConceptKey key,
            @NonNull final Map<PfConceptKey, ToscaServiceTemplate> conceptMap) {
     ...
     */
    public ToscaServiceTemplates(@NonNull final ToscaServiceTemplates copyConcept) {
        super(copyConcept);
    }
}
