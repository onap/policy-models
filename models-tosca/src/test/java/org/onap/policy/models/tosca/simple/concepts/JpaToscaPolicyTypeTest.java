...
public class JpaToscaPolicyTypeTest {
    ...
    public void testPolicyTypePojo() {
        ...
        assertTrue(tpt.validate("test").isValid());
    ...
    public void testGetReferencedDataTypes() {
        ...
        assertTrue(prop0.validate("test").isValid());
        ...
        assertTrue(prop1.validate("test").isValid());
        ...
        assertTrue(prop2.validate("test").isValid());
        ...
        assertTrue(prop3.validate("test").isValid());
        ...
        assertTrue(prop4.validate("test").isValid());
