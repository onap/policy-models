...
public class JpaToscaPolicyTypeTest {
    ...
    public void testPolicyTypePojo() {
        ...
        assertFalse(new JpaToscaPolicyType().validate("test").isValid());
        assertTrue(tpt.validate("test").isClean());

        tpt.getProperties().put(null, null);
        assertFalse(tpt.validate("test").isValid());
    ...
    public void testGetReferencedDataTypes() {
        ...
        assertTrue(prop0.validate("test").isClean());
        ...
        assertTrue(prop1.validate("test").isClean());
        ...
        assertTrue(prop2.validate("test").isClean());
        ...
        assertTrue(prop3.validate("test").isClean());
        ...
        assertTrue(prop4.validate("test").isClean());
