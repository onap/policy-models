...
public class AuthorativeToscaProviderPolicyTypeImplTest {
    ...
    private static ToscaPolicyTypeImplList toscaPolicyTypeImplList;
    private PfDao pfDao;
    ...
    public void fetchPolicyImplJson() throws Exception {
        toscaPolicyTypeImplList =
            standardCoder.decode(ResourceUtils.getResourceAsString(VCPE_JSON), ToscaPolicyTypeImplList.class);
    }
    ...
    public void testPolicyTypeImplGet() throws Exception {
        ...
        assertNotNull(toscaPolicyTypeImplList);
        List<ToscaPolicyTypeImpl> createdPolicyTypeImplList =
            authorativeToscaProvider.createPolicyTypeImpl(pfDao, toscaPolicyTypeImplList.getToscaPolicyTypeImplList());

        List<ToscaPolicyTypeImpl> gotPolicyImplList = authorativeToscaProvider.getFilteredPolicyTypeImpl(pfDao, null);
        assertEquals(1, gotPolicyImplList.size());
        assertEquals(0, toscaPolicyTypeImplList.getToscaPolicyTypeImplList().get(0).getPolicyTypeImplRef()
        ...
        List<ToscaPolicyTypeImpl> filteredAllPolicyTypeImpl = authorativeToscaProvider
            .getFilteredPolicyTypeImpl(pfDao, filterMap);
        assertEquals(1, filteredAllPolicyTypeImpl.size());
    ...
    public void testPolicyTypeImplCreate() throws Exception {
        ...
        List<ToscaPolicyTypeImpl> createdPolicyTypeImpl =
            authorativeToscaProvider.createPolicyTypeImpl(pfDao, toscaPolicyTypeImplList.getToscaPolicyTypeImplList());

        String inputPolicy = toscaPolicyTypeImplList.getToscaPolicyTypeImplList().get(0).getPolicyTypeImplRef()
            .getName();
        ...
        assertEquals(createdPolicyTypeImpl.get(0).getPolicyTypeImplRef().getVersion(),
            toscaPolicyTypeImplList.getToscaPolicyTypeImplList().get(0).getPolicyTypeImplRef().getVersion());
    }
    ...
    public void testPolicyTypeImplUpdate() throws Exception {
        ...
        toscaPolicyTypeImplList.getToscaPolicyTypeImplList().get(0).setPdpType("updated-pdp");
        ToscaPolicyTypeImpl updatedPolicyTypeImpl =
            authorativeToscaProvider.updatePolicyTypeImpl(pfDao, toscaPolicyTypeImplList.getToscaPolicyTypeImplList()
                .get(0));
    ...
    public void testPolicyTypeImplDelete() throws Exception {
        ...
        ToscaPolicyTypeImpl deletedPolicyTypeImpl =
            authorativeToscaProvider.deletePolicyTypeImpl(pfDao, toscaPolicyTypeImplList.getToscaPolicyTypeImplList()
