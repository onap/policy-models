...
public class DefaultPfDao implements PfDao {
    ...
    public <T extends PfConcept> List<T> getFiltered(final Class<T> someClass, final String name, final String version,
        ...
        String filterQueryString = generateFilterString(name, startTime, endTime);
     ...
     */
    private String generateFilterString(final String name, final Date startTime, final Date endTime) {
        ...
        if (name != null) {
            String nameFilter = " AND c.key.name = :name";
            filterQueryString = filterQueryString.concat(nameFilter);
        }
