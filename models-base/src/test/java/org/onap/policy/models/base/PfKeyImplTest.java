...
public class PfKeyImplTest {
    ...
    public void testValidation() throws Exception {
        ...
        assertThat(validationResult.getResult()).contains("INVALID, parameter name with value Key Name "
        ...
        assertThat(validationResult2.getResult()).contains("INVALID, parameter version with value Key Version "
