...
public class PfReferenceKeyTest {
    ...
    public void testValidation() throws Exception {
        ...
        assertThat(result.getResult()).contains("INVALID, parameter parentKeyName with value Parent Name "
        ...
        assertThat(validationResult2.getResult())
                        .contains("INVALID, parameter parentKeyVersion with value Parent Version "
        ...
        assertThat(validationResult3.getResult()).contains("INVALID, parameter parentLocalName with value "
        ...
        assertThat(validationResult4.getResult())
                        .contains("INVALID, parameter localName with value Local Name "
