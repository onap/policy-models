...
public interface Validated {
    ...
    /**
     * Validates this value, ensuring that it isn't null and that it is structurally valid.
     *
     * @param fieldName name of the field containing this concept
     * @return the validation result or {@code null} (if it's clean)
     */
    default ValidationResult validateNotNull(@NonNull final String fieldName) {
        return null;
    }
}
