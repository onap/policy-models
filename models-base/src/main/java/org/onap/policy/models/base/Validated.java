...
public class Validated {
    ...
    /**
     * Validates the contents of a field, verifying that it is not null and that it
     * matches a pattern.
     *
    ...
    public void validateText(Object container, String fieldName, String value, String pattern,
        ...
        } else if ((errmsg = Assertions.getStringParameterValidationMessage(fieldName, value, pattern)) != null) {
            result.addValidationMessage(new PfValidationMessage(makeKey(container), container.getClass(),
