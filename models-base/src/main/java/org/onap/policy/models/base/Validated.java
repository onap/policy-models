...
public class Validated {
     ...
     * @param result where to place the result
     */
    public void validateNotNull(Object container, String fieldName, Object value, PfValidationResult result) {
     ...
     * @param result where to place the result
     */
    public void validatePropertiesNotNull(Object container, String fieldName, Map<String, ?> properties,
                    PfValidationResult result) {
        ...
        for (Entry<String, ?> ent : properties.entrySet()) {
            ...
            validateNotNull(container, keyName, key, result);

            validateNotNull(container, keyName, ent.getValue(), result);
        }
    }
     ...
     */
    public void addError(Object container, String fieldName, PfValidationResult result, String errmsg) {
        if (errmsg != null) {
            result.addValidationMessage(new PfValidationMessage(makeKey(container), container.getClass(),
