...
public class Validated {
    ...
    public PfValidationResult validateNotNull(@NonNull PfConceptKey value, @NonNull PfValidationResult result) {
        ...
        if (PfConceptKey.NULL_KEY_NAME.equals(value.getName())) {
            result.addValidationMessage(new PfValidationMessage(value, value.getClass(), ValidationResult.INVALID,
                            "name invalid-null"));
        }

        if (PfConceptKey.NULL_KEY_VERSION.equals(value.getVersion())) {
            result.addValidationMessage(new PfValidationMessage(value, value.getClass(), ValidationResult.INVALID,
                            "version invalid-null"));
        }
     ...
     * @return the result
     */
    public PfValidationResult validatePropertiesNotNull(@NonNull Object container, @NonNull String fieldName,
                    Map<String, ?> properties, @NonNull PfValidationResult resultIn) {
        ...
        for (Entry<String, ?> ent : properties.entrySet()) {
     ...
     * @return the result
     */
    public PfValidationResult validateCollectionNotNull(@NonNull Object container, @NonNull String fieldName,
                    Collection<?> collection, @NonNull PfValidationResult resultIn) {
     ...
     * @return the result
     */
    public PfValidationResult validateCollection(@NonNull Object container, @NonNull String fieldName,
                    Collection<? extends Validated> collection, @NonNull PfValidationResult result) {

        if (collection == null) {
            return result;
        }

        for (Validated item : collection) {
            if (item != null) {
     ...
     * @return the result
     */
    public PfValidationResult validateConceptCollection(@NonNull Object container, @NonNull String fieldName,
                    Collection<? extends PfConcept> collection, @NonNull PfValidationResult result) {

        if (collection == null) {
            return result;
        }

        for (PfConcept item : collection) {
            if (item != null) {
                result = item.validate(result);
            }
        }
