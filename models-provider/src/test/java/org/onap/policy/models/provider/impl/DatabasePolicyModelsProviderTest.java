...
public class DatabasePolicyModelsProviderTest {
    ...
    public void testProviderMethods() throws PfModelException {
        ...
        assertThatThrownBy(() -> databaseProvider.getPolicyTypeList(NAME, VERSION_100))
                .hasMessage("service template not found in database");

        assertThatThrownBy(() -> databaseProvider.getFilteredPolicyTypes(ToscaPolicyTypeFilter.builder().build()))
                .hasMessage("service template not found in database");

        assertThatThrownBy(() -> databaseProvider.getFilteredPolicyTypeList(ToscaPolicyTypeFilter.builder().build()))
                .hasMessage("service template not found in database");
        ...
        assertThatThrownBy(() -> databaseProvider.getPolicyList(NAME, VERSION_100))
                .hasMessage("service template not found in database");

        assertThatThrownBy(() -> databaseProvider.getFilteredPolicies(ToscaPolicyFilter.builder().build()))
                .hasMessage("service template not found in database");

        assertThatThrownBy(() -> databaseProvider.getFilteredPolicyList(ToscaPolicyFilter.builder().build()).size())
                .hasMessage("service template not found in database");
