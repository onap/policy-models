...
public class JpaPolicyAuditTest {
    ...
    public void testToAuthorative() {
        ...
        JpaPolicyAudit jpaAuditWithNullTimestamp = new JpaPolicyAudit(audit);
        PolicyAudit convertedAudit2 = jpaAuditWithNullTimestamp.toAuthorative();
    ...
    public void testValidation() {
        ...
        assertThat(result.getResult()).contains("policy name", "policy version", "action", "timeStamp");

        assertThatThrownBy(() -> {
            jpaAudit.validate(null);
