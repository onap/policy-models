...
public class Service implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (serviceInvariantUUID != null ? !serviceInvariantUUID.equals(other.serviceInvariantUUID)
                : other.serviceInvariantUUID != null) {
            return false;
        }
        ...
        if (serviceVersion != null ? !serviceVersion.equals(other.serviceVersion) : other.serviceVersion != null) {
            return false;
        }
        return true;
    }
