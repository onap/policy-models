 ...
 * a streaming approach, which means the client sends an event to which the server can reply with
 * multiple sub-responses, until full completion of the processing.
 * </p>
 */
public class CdsProcessorGrpcClient implements AutoCloseable {

    private static final Logger log = LoggerFactory.getLogger(CdsProcessorGrpcClient.class);
     ...
     */
    public CdsProcessorGrpcClient(final CdsProcessorListener listener, CdsProperties props) {
        ...
        log.info("CdsProcessorListener started");
    }
    ...
    public void close() {
        ...
        log.info("CdsProcessorListener stopped");
    }
}
