...
public class CdsActorServiceProviderTest {
    ...
    @Test
    public void testConstructRequest() throws CdsActorServiceProviderException {
    ...
    @Test
    public void testSendRequestToCdsSuccess() throws CdsActorServiceProviderException {
    ...
    @Test
    public void testSendRequestToCdsLatchInterrupted() throws InterruptedException, CdsActorServiceProviderException {
        // Reset cdsClient
    ...
    public void testOnMessage() {
        ...
        cdsActor.onMessage(message);
        assertEquals(cdsActor.getCdsResponse(), CdsActorConstants.FAILED);
        ...
        cdsActor.onMessage(message);
        assertEquals(cdsActor.getCdsResponse(), CdsActorConstants.SUCCESS);

        message = ExecutionServiceOutput.newBuilder()
            .setStatus(Status.newBuilder().setEventType(EventType.EVENT_COMPONENT_PROCESSING).build()).build();
        cdsActor.onMessage(message);
        assertEquals(cdsActor.getCdsResponse(), CdsActorConstants.PROCESSING);
    }
}
