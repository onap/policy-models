...
public class VfModuleDeleteTest extends BasicSoOperation {
    ...
    public void testDelete() throws Exception {
        ...
        assertEquals("http://my-host:6969/base-uri/my-uri", req2.uri().toString());
    ...
    public void testGetUriPrefix() {
        assertEquals("http://my-host:6969/base-uri", oper.getUriPrefix());

        // try https
        when(client.isHttps()).thenReturn(true);
        assertEquals("https://my-host:6969/base-uri", oper.getUriPrefix());
    }
    ...
    private void initHostPort() {
        when(client.getHostname()).thenReturn("my-host");
        when(client.getPort()).thenReturn(6969);
    }
