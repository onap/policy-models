...
public class OperatorPartialTest {
    ...
    public void testStartOperation_testVerifyRunning() {
        verifyRunOnce("testStartOperation", 1, 1, PolicyResult.SUCCESS);
    }

    private void verifyRunOnce(String testName, int expectedCallbacks, int expectedOperations,
        ...
        verifyRunOnce(testName, expectedCallbacks, expectedOperations, expectedResult, expectedSubRequestId, noop());
    }

    private void verifyRunOnce(String testName, int expectedCallbacks, int expectedOperations,
                    PolicyResult expectedResult, Consumer<CompletableFuture<ControlLoopOperation>> manipulator) {

        String expectedSubRequestId =
                        (expectedResult == PolicyResult.FAILURE_EXCEPTION ? null : String.valueOf(expectedOperations));

        verifyRunOnce(testName, expectedCallbacks, expectedOperations, expectedResult, expectedSubRequestId,
                        manipulator);
    }

    private void verifyRunOnce(String testName, int expectedCallbacks, int expectedOperations,
                    PolicyResult expectedResult, String expectedSubRequestId,
    ...
    public void testStartOperationWithPreprocessor_testStartPreprocessor() {
        ...
        verifyRunOnce("testStartOperationWithPreprocessor_testStartPreprocessor", 1, 1, PolicyResult.SUCCESS);
    ...
    public void testStartPreprocessorFailure() {
        ...
        verifyRunOnce("testStartPreprocessorFailure", 1, 0, PolicyResult.FAILURE_GUARD);
    }
    ...
    public void testStartPreprocessorException() {
        ...
        verifyRunOnce("testStartPreprocessorException", 1, 0, PolicyResult.FAILURE_GUARD);
    }
    ...
    public void testSetRetryFlag_testRetryOnFailure_ZeroRetries() {
        ...
        verifyRunOnce("testSetRetryFlag_testRetryOnFailure_ZeroRetries", 1, 1, PolicyResult.FAILURE);
    }
    ...
    public void testSetRetryFlag_testRetryOnFailure_NullRetries() {
        ...
        verifyRunOnce("testSetRetryFlag_testRetryOnFailure_NullRetries", 1, 1, PolicyResult.FAILURE);
    }
    ...
    public void testSetRetryFlag_testRetryOnFailure_RetriesExhausted() {
        ...
        verifyRunOnce("testVerifyRunningWhenNot", maxRetries + 1, maxRetries + 1, PolicyResult.FAILURE_RETRIES);
    }
    ...
    public void testSetRetryFlag_testRetryOnFailure_SuccessAfterRetries() {
        ...
        verifyRunOnce("testSetRetryFlag_testRetryOnFailure_SuccessAfterRetries", maxFailures + 1, maxFailures + 1,
    ...
    public void testSetRetryFlag_testRetryOnFailure_NullOutcome() {
        ...
        verifyRunOnce("testSetRetryFlag_testRetryOnFailure_NullOutcome", 1, 1, PolicyResult.FAILURE, null, noop());
    }
    ...
    public void testOnSuccessTrue_testHandleFailureTrue() {
        ...
        verifyRunOnce("testOnSuccessTrue_testHandleFailureTrue", 1, 1, PolicyResult.SUCCESS);
    }
    ...
    public void testOnSuccessFalse_testHandleFailureFalse() throws Exception {
        ...
        verifyRunOnce("testOnSuccessFalse_testHandleFailureFalse", 1, 0, PolicyResult.FAILURE_GUARD);
    }
    ...
    public void testOnSuccessFalse_testHandleFailureNull() throws Exception {
        ...
        verifyRunOnce("testOnSuccessFalse_testHandleFailureNull", 1, 0, PolicyResult.FAILURE_GUARD);
    }
    ...
    public void testFromException() {
        ...
        verifyRunOnce("testFromException", 1, 1, PolicyResult.FAILURE_EXCEPTION);
    }
    ...
    public void testFromExceptionNoExcept() {
        verifyRunOnce("testFromExceptionNoExcept", 1, 1, PolicyResult.SUCCESS);
    }
    ...
    public void testVerifyRunningWhenNot() {
        verifyRunOnce("testVerifyRunningWhenNot", 0, 0, PolicyResult.SUCCESS, future -> future.cancel(false));
    }
