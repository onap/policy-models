...
public class ActorServiceTest {
    ...
    /**
     * Initializes the fields and a fully populated {@link #service}.
     */
    @Before
    public void setUp() {
    ...
    public void testGetActors() {
        // map to tree set so it's sorted
        Set<String> actorNames = service.getActors().stream().map(Actor::getName).collect(Collectors.toSet());
        assertEquals("[actor A, actor B, actor C, actor D]", new TreeSet<>(actorNames).toString());
    }

    @Test
    public void testGetActorNames() {
        // map to tree set so it's sorted
        Set<String> actorNames = service.getActorNames();
        assertEquals("[actor A, actor B, actor C, actor D]", new TreeSet<>(actorNames).toString());
    }
     ...
     */
    @Test
    public void testDoConfigureMapOfStringObjectExceptions() {
     ...
     */
    @Test
    public void testDoConfigureMapOfStringObjectConfigured() {
