...
public abstract class OperationManagerPartial extends ConfigImpl<Map<String, Object>> implements OperationManager {
    ...
    public CompletableFuture<ControlLoopOperation> startOperation(ClosedLoopOperationParams params) {
        ...
        final ClosedLoopOperationParams params1 = params.toBuilder().attempt(1)
     ...
     */
    public CompletableFuture<ControlLoopOperation> startOperationOnce(ClosedLoopOperationParams params) {
     ...
     */
    protected Function<ControlLoopOperation, ControlLoopOperation> determineRetries(ClosedLoopOperationParams params) {
        return operation -> {
    ...
    protected Function<ControlLoopOperation, CompletableFuture<ControlLoopOperation>> retryOnFailure(
                    ClosedLoopOperationParams parentParams, int attempt) {
        ...
        return operation -> {
            ...
            ClosedLoopOperationParams params1 = parentParams.toBuilder().attempt(newAttempt)
     ...
     *         unchanged
     */
    protected Function<ControlLoopOperation, ControlLoopOperation> stopPipeline(ClosedLoopOperationParams params) {
        return operation -> {
            params.stopPipeline();
            return operation;
        };
     ...
     * that are made by {@link #doOperationAsFuture(ClosedLoopOperationParams)}. This
     ...
     */
    protected ControlLoopOperation doOperation(ClosedLoopOperationParams params, ControlLoopOperation operation) {
     ...
     */
    public Function<ControlLoopOperation, ControlLoopOperation> callbackCompleted(ClosedLoopOperationParams params) {
