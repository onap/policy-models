...
import org.onap.policy.controlloop.actorserviceprovider.impl.ConfigImpl;
...
public class ActorService extends ConfigImpl<Map<String, Object>> {
    ...
    protected void doConfigure(Map<String, Object> parameters) {
        ...
        for (Actor actor : name2actor.values()) {
            ...
            if (subparams == null) {
                ...
                Util.logException(() -> actor.configure(subparams), "failed to configure actor " + actorName);
            }
        }
    }
    ...
    protected void doStop() {
        ...
        name2actor.values().forEach(actor -> Util.logException(actor::stop, "failed to stop actor " + actor.getName()));
    }
