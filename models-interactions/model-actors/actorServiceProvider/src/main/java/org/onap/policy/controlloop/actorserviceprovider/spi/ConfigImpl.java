...
/**
 * Implementation of a startable and configurable object.
 *
 * @param <T> type of parameters
 */
public abstract class ConfigImpl<T> implements Startable, Configurable<T> {
     ...
     */
    public ConfigImpl(String fullName) {
    ...
    public synchronized void configure(T parameters) {
        if (isAlive()) {
            throw new IllegalStateException("attempt to reconfigure running " + getFullName());
        }
