...
public interface ClosedLoopOperationParams {
     ...
     */
    VirtualControlLoopEvent getEvent();
    ...
    /**
     * Gets the associated A&AI data, which need not be fully populated.
     *
     * @return associated A&AI data
     */
    ControlLoopAaiData getAaiData();
