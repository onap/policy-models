...
public class Util {
     ...
     */
    public static DelayedIdentString ident(Object object) {
    ...
    private static class DelayedIdentString {
        private Object object;

        public DelayedIdentString(Object object) {
            this.object = object;
        }

        // TODO add junits for this

        public String toString() {
            String ident = object.toString();
            if (ident == null) {
                return null;
            }
