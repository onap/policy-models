...
/**
 * Partial implementation of a startable and configurable object.  It provides the high level
 * methods defined in the interface, while deferring the details to abstract methods that must
...
public abstract class ConfigurablePartial<T> implements Startable, Configurable<T> {
    ...
    /**
     * This method invokes {@link Operator#configure(Map)} on each operation. It
