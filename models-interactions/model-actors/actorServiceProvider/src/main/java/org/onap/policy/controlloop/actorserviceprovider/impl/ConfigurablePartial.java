...
/**
 * Partial implementation of a startable and configurable object. It provides the high
 * level methods defined in the interface, while deferring the details to abstract methods
 * that must be provided by the subclasses. It also manages the current {@link #state}.
 *
 * @param <T> type of parameters
 */
public abstract class ConfigurablePartial<T> implements Startable, Configurable<T> {
    private static final Logger logger = LoggerFactory.getLogger(ConfigurablePartial.class);
     ...
     */
    public ConfigurablePartial(String fullName) {
