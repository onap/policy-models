...
public interface OperationManager extends Startable, Configurable<Map<String, Object>> {
    ...
    /**
     * Called by enforcement PDP engine to start any preprocessing (e.g., A&AI queries,
     * guard checks) needed by the operation. It is responsible for catching any
     * exceptions in the "future" pipeline and converting them to an appropriate outcome.
     *
     * @param params parameters needed to start the operation preprocessor
     * @return a future that will return the result of the operation, or {@code null} if
     *         no preprocessing is required
     */
    CompletableFuture<ControlLoopOperation> startPreProcessor(ClosedLoopOperationParams params);
