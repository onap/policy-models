...
public interface OperationManager extends Startable, Configurable<Map<String, Object>> {
     ...
     */
    CompletableFuture<OperationOutcome> startOperation(ClosedLoopOperationParams params);
     ...
     */
    <T> CompletableFuture<OperationOutcome> buildSubOperation(ClosedLoopOperationParams params,
