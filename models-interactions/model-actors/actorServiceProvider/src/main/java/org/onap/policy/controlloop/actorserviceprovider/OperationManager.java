...
public interface OperationManager extends Startable, Configurable<Map<String, Object>> {
     ...
     */
    CompletableFuture<PolicyResult> startOperation(ClosedLoopOperationParams params);

    /**
     * Builds a sub-operation, appending it to a pipeline.
     *
     ...
     */
    <T> CompletableFuture<PolicyResult> buildSubOperation(ClosedLoopOperationParams params, CompletableFuture<T> future,
