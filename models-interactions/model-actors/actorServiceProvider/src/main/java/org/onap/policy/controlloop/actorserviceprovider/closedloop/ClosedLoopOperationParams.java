...
package org.onap.policy.controlloop.actorserviceprovider.closedloop;
...
@AllArgsConstructor
public class ClosedLoopOperationParams {
     ...
     */
    private Consumer<ControlLoopOperation> endCallback;
     ...
     */
    public ClosedLoopOperationParams(ClosedLoopOperationParams parent) {
        this.attempt = 1;
    ...
    /**
     * Starts the preprocessing steps (e.g., A&AI queries, guard checks) associated with
     ...
     *         stop it.
     */
    public CompletableFuture<ControlLoopOperation> startPreProcessor() {
