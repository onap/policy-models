...
public class BandwidthOnDemandManager extends SdncManager {
    private static final Logger logger = LoggerFactory.getLogger(BandwidthOnDemandManager.class);
     ...
     */
    public BandwidthOnDemandManager(String actorName) {
