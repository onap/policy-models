...
public class BasicActor {
     ...
     */
    private MyConfig readConfig(String yamlConfigFile) throws AssertionError {
        try {
            ...
            logger.error("cannot decode YAML file {}", yamlConfigFile, e);
            throw new AssertionError("verifyActorService");
        }
    }
     ...
     */
    private void startOtherServices(MyConfig config) throws Exception {
        stopOtherServices();
