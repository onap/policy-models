...
public class BasicActorTest extends BasicActor {
    ...
    /**
     * For some reason, the META-INF service file is not being picked up in the jenkins
     * build, so this just manually loads the list of actors into the "service loader".
     */
    @Before
    public void setUp() {
        setActors(Arrays.asList(new DummyActor()));
    }
