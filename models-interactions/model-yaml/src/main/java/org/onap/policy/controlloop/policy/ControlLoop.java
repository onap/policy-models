...
public class ControlLoop implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        boolean isEq = equalsMayBeNull(controlLoopName, other.controlLoopName) && equalsMayBeNull(resources, other.resources)
                && equalsMayBeNull(services, other.services);
        isEq = isEq && equalsMayBeNull(timeout, other.timeout)
