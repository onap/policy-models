...
/**
 * Class to perform unit test of {@link PolicyType}.
 *
 * @author Chenfei Gao (cgao@research.att.com)
 *
 */
public class TestPolicyType {
    ...
    public void testPolicyType() {
        ...
        validator.validate(PolicyType.class.getPackage().getName(),
                new FilterClassName(PolicyType.class.getName()));
    }
}
