...
/**
 * Class to perform unit test of {@link PolicyList}.
 *
 * @author Chenfei Gao (cgao@research.att.com)
 *
 */
public class TestPolicyList {
    ...
    public void testPolicyList() {
        ...
        validator.validate(PolicyList.class.getPackage().getName(),
                new FilterClassName(PolicyList.class.getName()));
    }
}
