...
/**
 * Class to perform unit test of {@link EntrySchema}.
 *
 * @author Chenfei Gao (cgao@research.att.com)
 *
 */
public class TestEntrySchema {
    ...
    public void testEntrySchema() {
        ...
        validator.validate(EntrySchema.class.getPackage().getName(),
                new FilterClassName(EntrySchema.class.getName()));
    }
}
