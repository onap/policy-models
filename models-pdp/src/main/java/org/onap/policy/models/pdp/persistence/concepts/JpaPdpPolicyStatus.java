...
public class JpaPdpPolicyStatus extends PfConcept implements PfAuthorative<PdpPolicyStatus> {
    ...
    /*
     * The name of the column is "name", which allows us to use PfDao.getAllVersions() to
     * retrieve all records for a given PDP group.
     */
    @Column
    @NotNull
    ...
    public void fromAuthorative(PdpPolicyStatus source) {
        ToscaConceptIdentifier policyIdent = source.getPolicy();
