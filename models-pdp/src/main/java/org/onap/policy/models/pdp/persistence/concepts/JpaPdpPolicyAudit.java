...
@Table(
        name = "PdpPolicyAudit",
        indexes = {@Index(name = "PdpPolicyAuditIndex", columnList = "timeStamp")})
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Data
@EqualsAndHashCode(callSuper = false)
public class JpaPdpPolicyAudit extends PfConcept implements PfAuthorative<PdpPolicyAudit> {
     ...
     */
    public JpaPdpPolicyAudit(PdpPolicyAudit tracker) {
     ...
     */
    public JpaPdpPolicyAudit(JpaPdpPolicyAudit copyConcept) {
    ...
    public int compareTo(PfConcept o) {
        ...
        final JpaPdpPolicyAudit other = (JpaPdpPolicyAudit) o;
    ...
    @Override
    public void fromAuthorative(PdpPolicyAudit authorativeConcept) {
        final ToscaConceptIdentifier policyIdent = authorativeConcept.getPolicy();

        key = new PfGeneratedIdKey(policyIdent.getName(), policyIdent.getVersion(), authorativeConcept.getAuditId());

        pdpGroup = authorativeConcept.getPdpGroup();
        pdpType = authorativeConcept.getPdpType();
        action = authorativeConcept.getAction();
        timeStamp = authorativeConcept.getTimestamp() == null ? null : Date.from(authorativeConcept.getTimestamp());
