...
import org.onap.policy.models.pdp.enums.PdpEngineState;
...
@ToString
@NoArgsConstructor
public class PdpEngineStatistics implements Serializable {
    private static final long serialVersionUID = 8262176849743624013L;

    private String engineId;
    private PdpEngineState engineState;
     ...
     */
    public PdpEngineStatistics(PdpEngineStatistics source) {
