...
public class PdpStatisticsProvider {
    ...
    public List<PdpStatistics> getFilteredPdpStatistics(@NonNull final PfDao dao, final String name,
        ...
        return asPdpStatisticsList(dao.getFiltered(JpaPdpStatistics.class,
                        PdpFilterParameters.builder().name(name).startTime(startTimeStamp).endTime(endTimeStamp)
                                        .group(pdpGroupName).subGroup(pdpSubGroup).sortOrder(sortOrder)
                                        .recordNum(getRecordNum).build()));
    }
     ...
     * @throws PfModelException on errors getting policies
     */
    public List<PdpStatistics> getFilteredPdpStatistics(@NonNull final PfDao dao, PdpFilterParameters filterParams) {
