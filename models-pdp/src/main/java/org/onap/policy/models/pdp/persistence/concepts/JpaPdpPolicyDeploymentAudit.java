...
@Entity
@Table(
        name = "PdpPolicyDeploymentAudit",
        indexes = {@Index(name = "PdpPolicyDeploymentAuditIndex", columnList = "timeStamp")})
...
public class JpaPdpPolicyDeploymentAudit extends PfConcept implements PfAuthorative<PdpPolicyDeploymentAudit> {
    ...
    public void clean() {
        ...
        changedByUser =
                Assertions.validateStringParameter("changedByUser", changedByUser, PfReferenceKey.LOCAL_NAME_REGEXP);
    }
}
