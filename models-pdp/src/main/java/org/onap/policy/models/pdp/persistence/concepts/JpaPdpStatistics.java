...
public class JpaPdpStatistics extends PfConcept implements PfAuthorative<PdpStatistics>, Serializable {
     ...
     * @param key the key
     */
    public JpaPdpStatistics(@NonNull final PfReferenceKey key) {
     ...
     */
    public JpaPdpStatistics(@NonNull final PfReferenceKey key, final long policyDeployCount,
    ...
    public PdpStatistics toAuthorative() {
        ...
        pdpStatistics.setPdpInstanceId(key.getLocalName());
    ...
    public void fromAuthorative(@NonNull final PdpStatistics pdpStatistics) {
        if (this.key == null || this.getKey().isNullKey()) {
            ...
            getKey().setLocalName(pdpStatistics.getPdpInstanceId());
        }
