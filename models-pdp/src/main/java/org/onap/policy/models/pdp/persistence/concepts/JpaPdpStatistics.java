...
public class JpaPdpStatistics extends PfConcept implements PfAuthorative<PdpStatistics>, Serializable {
    ...
    public JpaPdpStatistics(@NonNull final PfTimestampConceptKey key) {
        this(key, NULL_NAME, NULL_NAME, 0L, 0L, 0L, 0L, 0L, 0L);
    }
     ...
     */
    public JpaPdpStatistics(@NonNull final PfTimestampConceptKey key, @NonNull final String pdpGroupName,
            ...
            final long policyExecutedFailCount) {
        this.key = key;
