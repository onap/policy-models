...
import org.onap.policy.models.base.PfTimestampConceptKey;
...
public class JpaPdpStatistics extends PfConcept implements PfAuthorative<PdpStatistics>, Serializable {
    ...
    @EmbeddedId
    private PfTimestampConceptKey key;
    ...
    public JpaPdpStatistics() {
        this(new PfTimestampConceptKey());
    }
     ...
     * @param key the key
     */
    public JpaPdpStatistics(@NonNull final PfTimestampConceptKey key) {
        this(key, 0L, 0L, 0L, 0L, 0L, 0L);
    }
     ...
     */
    public JpaPdpStatistics(@NonNull final PfTimestampConceptKey key, final long policyDeployCount,
            final long policyDeploySuccessCount, final long policyDeployFailCount, final long policyExecutedCount,
            final long policyExecutedSuccessCount, final long policyExecutedFailCount) {
        this.key = key;
    ...
    public JpaPdpStatistics(@NonNull final JpaPdpStatistics copyConcept) {
        super(copyConcept);
        this.key = new PfTimestampConceptKey(copyConcept.key);
    ...
    public void fromAuthorative(@NonNull final PdpStatistics pdpStatistics) {
        if (this.key == null || this.getKey().isNullKey()) {
            this.setKey(new PfTimestampConceptKey(pdpStatistics.getPdpInstanceId(), PfKey.NULL_KEY_VERSION,
