...
public class PdpSubGroupTest {
    ...
    public void testValidatePapRest() throws Exception {
        ...
        subgrp.setSupportedPolicyTypes(Arrays.asList(makeIdent("policy-X", "3.0.0")));
        assertNull(subgrp.validatePapRest());
        ...
        // invalid policy item
        sub2 = new PdpSubGroup(subgrp);
        sub2.getSupportedPolicyTypes().set(0, makeIdent(null, "3.0.0"));
        assertInvalid(sub2);
    }
     ...
     */
    public ToscaPolicyTypeIdentifier makeIdent(String name, String version) throws CoderException {
        ...
        return coder.decode(json, ToscaPolicyTypeIdentifier.class);
    }
}
