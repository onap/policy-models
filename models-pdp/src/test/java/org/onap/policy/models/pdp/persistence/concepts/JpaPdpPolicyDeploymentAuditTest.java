...
public class JpaPdpPolicyDeploymentAuditTest {
    ...
    public void testClean() {
        audit.setChangedByUser("   user");
        JpaPdpPolicyDeploymentAudit jpaAudit = new JpaPdpPolicyDeploymentAudit(audit);
        assertThatNoException().isThrownBy(() -> jpaAudit.clean());
        assertEquals(USER, jpaAudit.getChangedByUser());
    }
    ...
    public void testToAuthorative() {
        ...
        JpaPdpPolicyDeploymentAudit jpaAuditWithNullTimestamp = new JpaPdpPolicyDeploymentAudit(audit);
        PdpPolicyDeploymentAudit convertedAudit2 = jpaAuditWithNullTimestamp.toAuthorative();
